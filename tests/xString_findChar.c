// unit test for xString_findChar function in xString module
...
int main(void) {
    struct test_case test_cases[] = {
        ...
        {"The quick brown fox jumps over the lazy dog.", 'o', 12},
    ...
    for (int i = 0; i < num_test_cases; i++) {
        ...
        int actual = xString_findChar(str, test_cases[i].sub);
