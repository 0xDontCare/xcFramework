// unit test for xString_replaceLastString function from xString module
...
int main(void)
{
    ...
    for(int i = 0; i < num_test_cases; i++)
    {
        ...
        xString_replaceLastString(str, sub, replace);

        assert(str->len == test_cases[i].expected_len && "xString_replaceLastString failed: length mismatch");
